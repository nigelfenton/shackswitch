    ...
    - - **Licence:** MIT
      - - **Platform:** Arduino Uno Q (migrated from Arduino Uno R4 WiFi + Raspberry Pi 4)
        ...
        **v2.0** — Arduino Uno Q
        ...
        ### Repo File Locations
        - `arduino-apps/sketch.ino` — STM32 firmware, relay control, Bridge RPC
        - - `arduino-apps/main.py` — Flask REST API, SmartSDR launcher (threaded)
          - - `arduino-apps/index.html` — Web UI (dark theme, served via Flask render_template)
