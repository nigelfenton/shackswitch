                                                              ...
                                                              - - OpenOCD binary: `/opt/openocd/bin/openocd`
                                                                - - Sketch binary: `/home/arduino/shackswitch-flash/sketch.ino.bin-zsk.bin`
                                                                  - - Flash config: `/home/arduino/shackswitch-flash/flash_sketch_ram.cfg`
                                                                    ...
                                                                    | Issue | Detail |
                                                                    |---|---|
                                                                    | KK1L display not correct in web UI | kk1l_available true but web UI matrix not routing/displaying KK1L state correctly |
                                                                    | Inactive ports still showing dimmed | Change ALL_PORTS to portCount in buildMatrix loop to hide completely |
                                                                    | RF2K-S antenna map not wired in | rfkit_antenna_map in config not yet used — PA sequencing in setband not implemented |
                                                                                ...
                                                                                - - `/rfkit/status`, `/rfkit/config`, `/rfkit/operate`, `/rfkit/fault/reset` endpoints: **live in main.py**
                                                                                  - - Amplifier page in web UI: **built and live in index.html**
                                                                                    - - rfkit_ip saved in config as `10.0.0.78` — amp currently unreachable (offline or IP not confirmed)
                                                                                      - - PA sequencing in `/setband` and `/kk1l/setband`: **not yet wired in**
                                                                                        - - rfkit_antenna_map: **in config schema, not yet used in code**
                                                                                          ...
                                                                                          - ```
                                                                                            ...
                                                                                            - [ ] | Near term | Wire rfkit PA sequencing into setband / kk1l_setband |
                                                                                            ...
                                                                                            - [ ] | Near term | Settings page — RF2K-S IP, antenna map, enable toggle |
